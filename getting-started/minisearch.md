...
This service allows users to **look into the content of the file** before downloading it. This is a very useful to speed up researcher's work as it gives users a quick look into the dataset.
